...
export class MapComp extends Component {
    ...
    addStudnt = ()=>{
        ...
        // push를 이용해서 직접접근해서 수정할 수 있지만
        // 화면에 바로 업데이트 되지 않는다
        // button의 click이벤트 발생시 업데이트 됨
        ...
        */
            ...
            // this.setState({students:newStudnets, inputText:""})
    ...
    // 전달해준  사용하기위해서 매개변수로 받아오기
    deleteStudent = (student)=> {
         // 1. 배열에서 값을 제거하는 방법
        // 1) pop, splice ..> 원래값에 제거 X
        // 2) 값을 제거하고 새로운 배열 생성 : filter
        // filter(걸러냄) 
        // : (value)=>return 참 일때 value값을 return배열에 추가
    ...
    render() {
        ...
        // map에 함수 를 넣어서 그 함수의 return값으로
        // 새로운 배열 자성
        // >> return값에 태그나, 컴포넌트를 넣어서 반복가능
        ...
        <div>
            ...
            {/* inpuit태그를 이용해서 값을 추가하고 state에 추가 
                        ...
                        this.state.students.map((student)=>
                            <tr key ={student.id}>
                                ...
                                <td
                                    ...
                                    // student의 값을 전달 하기위해서 화살표함수로 감싸기
